...
L.Control.Draw = L.Control.extend({
	...
	onAdd: function (map) {
		var container = L.DomUtil.create('li', 'leaflet-draw'),
			addedTopClass = false,
...
L.Toolbar = L.Class.extend({
    ...
    addToolbar: function (map) {
        var container = L.DomUtil.create('li', 'leaflet-draw-section'),
            buttonIndex = 0,
            buttonClassPrefix = this._toolbarClass || '',
            modeHandlers = this.getModeHandlers(map),
            i;

        this._toolbarContainer = L.DomUtil.create('li', 'leaflet-draw-toolbar leaflet-bar');
        this._map = map;
        ...
        this._actionsContainer = L.DomUtil.create('li', 'leaflet-draw-actions');
